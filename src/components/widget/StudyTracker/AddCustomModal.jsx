  ...
  return (
    ...
    >
      <motion.div
        ...
        animate={{ scale: 1 }}
        exit={{ scale: 0.9 }}
        className="bg-[#1b1b1bcc] backdrop-blur-2xl text-white p-6 rounded-2xl border border-white/10 w-[90%] max-w-[400px]"
      >
        ...
        <div className="space-y-3">
          <input
            ...
            className="w-full bg-[#222] border border-[#333] px-3 py-2 rounded-md text-sm"
          />
          <input
            value={newSubject}
          ...
          <textarea
            ...
            rows={3}
            className="w-full bg-[#222] border border-[#333] px-3 py-2 rounded-md text-sm resize-none"
          />
          <button
            onClick={addCustom}
            className="w-full py-2 bg-blue-600 hover:bg-blue-700 rounded-md text-sm"
          >
            Add
          </button>
        </div>
